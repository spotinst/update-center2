...
wget --no-verbose -O "$MAIN_DIR"/tmp/generator.zip "https://repo.jenkins-ci.org/snapshots/org/jenkins-ci/update-center2/3.4.5-SNAPSHOT/update-center2-3.4.5-20200924.102611-1-bin.zip"
